...
CTransaction::CTransaction(const CMutableTransaction &tx, const uint256 &hash) : nVersion(tx.nVersion), vin(tx.vin), vout(tx.vout), nLockTime(tx.nLockTime), hash(hash) {}
