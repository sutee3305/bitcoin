...
BOOST_AUTO_TEST_CASE(ccoins_modify_new)
{
    ...
    CheckModifyNewCoins(VALUE2, ABSENT, FAIL  , 0          , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE2, ABSENT, PRUNED, 0          , DIRTY      , true );
    CheckModifyNewCoins(VALUE2, ABSENT, FAIL  , FRESH      , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE2, ABSENT, ABSENT, FRESH      , NO_ENTRY   , true );
    CheckModifyNewCoins(VALUE2, ABSENT, FAIL  , DIRTY      , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE2, ABSENT, PRUNED, DIRTY      , DIRTY      , true );
    CheckModifyNewCoins(VALUE2, ABSENT, FAIL  , DIRTY|FRESH, NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE2, ABSENT, ABSENT, DIRTY|FRESH, NO_ENTRY   , true );
